...
<td><input type="text" name="item_total" jAutoCalc="{qty} + {price}" class="form-control form-control-sm"/></td></tr>
                  
                 <tr>
                       <td colspan="2">&nbsp;</td>
                       <td>Total</td>
                       <td>&nbsp;</td>
                       <td><input type="text" name="grand_total" jAutoCalc="SUM({item_total})"
             ...
             <input type="submit" id="sendBill" name="sendBill" class="btn btn-success"
              style="margin:4% 15% 5% 35%;" value="Send Bill To User" />
       
 </form>
         <input type="button" id="btnExport" class="btn btn-success" 
         style="margin:-11% 10% 5% 50%;" value="Generate Bill" />
